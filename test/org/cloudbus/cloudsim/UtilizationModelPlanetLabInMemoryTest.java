...
public class UtilizationModelPlanetLabInMemoryTest {
	...
	public static final String FILE = System.getProperty("user.dir") + "/test/resources/146-179_surfsnel_dsl_internl_net_colostate_557.dat";

	private UtilizationModelPlanetLabInMemory utilizationModel;

	@Before
	public void setUp() throws Exception {
		utilizationModel = new UtilizationModelPlanetLabInMemory(FILE, SCHEDULING_INTERVAL);
	}
