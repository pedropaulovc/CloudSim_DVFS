 ...
 */
public class PowerModelSpecPower_REIMS_Net extends PowerModelSpecPowerDVFS {
     ...
     */
        ...
        double Tab_Power_idle[]={272,272,272,272,272};
        double Tab_Power_full[]={272,272,272,272,272};
	List<Pe> peList;

        Pe tmp_pe;
        
         public PowerModelSpecPower_REIMS_Net () {}
        public PowerModelSpecPower_REIMS_Net ( List<Pe> PeList_) 
        {                
                peList = PeList_;
