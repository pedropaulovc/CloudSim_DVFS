...
public class TestPolicy extends Policy {
	...
	public static void main(String[] args){
		String dagFile = System.getProperty("user.dir") + "/dag/Sipht_30.xml";
		
		TestPolicy policy = new TestPolicy();
		policy.processDagFile(dagFile, 1, 1000, 100, null);
	...
	private void printDAG(){
		...
		for(DataItem d:originalDataItems){
			System.out.println("=> Name:" + d.getName()+" (Id:"+d.getId()+") ,  size: " + d.getSize());
		}
